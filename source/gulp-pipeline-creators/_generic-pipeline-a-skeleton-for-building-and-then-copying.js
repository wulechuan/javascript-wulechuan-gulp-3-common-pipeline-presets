...
function buildAPipelineForBuildingOneAppOrOnePage({ // eslint-disable-line max-statements
	...
	let taskNameOfLastTask;
	if (shouldCopyBuiltFileToElsewhere) {
		taskNameOfLastTask = taskNameOfBuildingAndThenCopyingBuiltOutputFiles;
	} else {
		taskNameOfLastTask = taskNameOfDeletingOldOutputFilesAndThenBuilding;
	}
